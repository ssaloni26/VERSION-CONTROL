...
export default class News extends LightningElement { 
    ...
    allowedDomains = [ 
        "abc.com", "cdn.abcotvs.com", "abcnews.go.com", "www.aljazeera.com", "i0.wp.com",
        ...
        "www.thedailybeast.com", "deadline.com", "dims.apnews.com", "cff2.earth.com",
        "www.esa.int", "s.espncdn.com", "ewscripps.brightspotcdn.com",
        ...
        "media.cnn.com", "platform.mmafighting.com", "nypost.com",
        "s3media.247sports.com", "www.newsnationnow.com", "images.nintendolife.com",
        "www.politico.com", "images.pushsquare.com", "pyxis.nymag.com",
        "www.ringsidenews.com", "www.rollingstone.com", "scitechdaily.com",
        "scx2.b-cdn.net", "compote.slate.com", "sportsfly.cbsistatic.com",
        "static0.moviewebimages.com", "chicago.suntimes.com", "www.tampabay.com",
        "techcrunch.com", "photos.thetrek.co", "images.timeextension.com",
        "nbc-sports-production-nbc-sports.s3.us-east-1.amazonaws.com", "variety.com",
        "platform.theverge.com", "vegoutmag.com", "www.washingtonpost.com",
        "wrestlingnews.co", "nasawatch.com"
    ]; 
    ...
    handleSearch() { 
        ...
        if (!category) { 
            this.errorMessage = 'Please enter a category to search.'; 
            return; 
        } 
        const validCategories = this.categories.map(c => c.value); 
        if (!validCategories.includes(category)) { 
            this.errorMessage = `Category "${category}" not recognized. Try: ${validCategories.join(', ')}`; 
            return; 
        }
